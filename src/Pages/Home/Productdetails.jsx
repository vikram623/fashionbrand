...
export default function Productdetails() {
  ...
  let addcart = (item) => {
    axios.post("https://fashionbrandbackend-b71e.vercel.app/addcart", { item }).then((res) => {
  ...
  let wishlistproduct = (itemwish) => {
    axios.post("https://fashionbrandbackend-b71e.vercel.app/wishlist", { itemwish }).then((res) => {
  ...
  let addreview = () => {
    axios.post("https://fashionbrandbackend-b71e.vercel.app/productreview", { review, product_id,productname }).then((res) => {
      if (res.data.status) {
        Swal.fire({
          title: "Review Submit",
          icon: "success"
  ...
  let reviewapidata = () => {
    axios.get("https://fashionbrandbackend-b71e.vercel.app/allreview").then((res) => {
      if (res.data.status) {
