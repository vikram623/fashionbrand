...
{/* mobile tooggle */}
              <div>
                <button
                    className="fixed top-2 left-0 top-0 text-2xl text-gray-800 bg-white  rounded-md  md:hidden"
            ...
            { sidebaropen && (
                <aside className="fixed top-0 left-0 w-72 bg-white border-r shadow-md  md:flex flex-col justify-between">
                <div>
                    <div className="p-6 flex items-center justify-between">
                        <Link to="/home"><h1 className="text-2xl font-bold text-blue-600">ElectroHut</h1></Link>
                    </div>
